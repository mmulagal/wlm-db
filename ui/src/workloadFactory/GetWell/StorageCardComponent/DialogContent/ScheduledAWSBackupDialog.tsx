...
// import { setSelectedSnapshot, selectedawsBackup } from '../../../../store/workloadFactory/getWellOptimizeSlice';
import { setSelectedAWSBackup, setSelectedawsBackup } from '../../../../store/workloadFactory/getWellOptimizeSlice';
...
const ScheduledAWSBackupDialog = ({ type }: any) => {
    ...
    const { selectedResourceId, selectedDatabaseInstance, selectedAWSBackup, selectedawsBackup } = useAppSelector(
        ...
        <div className={styles['storage-tier-block']}>
            <div className={styles['first-section']}>
                ...
                <DsTypography variant="Regular_14">
                    Workload Factory recommends enabling backup on your FSx for ONTAP filesystem to set retention based scheduled backups of your data volumes
                </DsTypography>
            </div>
            ...
            <div className={styles['first-section']}>
                ...
                <div className={styles.content}>
                    <div className={styles.row}>
                        <DsTypography variant="Regular_14">
                            Choose the number of days (between 1 and 90 days) that FSx for ONTAP should retain automatic backups for the serving file system.
                        </DsTypography>
                    </div>
                    <div className={styles.row}>
                        <DsTypography variant="Regular_14">
                    ...
                    <div className={styles.row} style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <span>:</span>
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginLeft: '5px', marginRight: '5px' }}>
                ...
                <div className={styles['first-section']}>
                    ...
                    <div className={styles.content}>
                        ...
                        <div className={styles.row}>
                            ...
                            <DsTypography variant="Regular_14">
                                The backup window will be scheduled for
                            </DsTypography>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles['first-section']}>
                    ...
                    <div className={styles.content}>
                        ...
                        <div className={styles.row}>
                            ...
                            <DsTypography variant="Regular_14">
                                Offline volumes cannot be backed up.
                            </DsTypography>
                        </div>
                        <div className={styles.row}>
                            <div>
