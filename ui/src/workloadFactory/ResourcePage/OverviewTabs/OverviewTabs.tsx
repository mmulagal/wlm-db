...
const OverviewTabs = () => {
    ...
    return (
        <div className={styles.overviewTabs}>
            <div
                className={
                    selectedTab === WLF_TABS.OVERVIEW ? `${styles.headers} ${styles.active}` : `${styles.headers}`
                }
            >
                <Typography
                    variant="Semibold_14"
            ...
            <div
                className={
                    selectedTab === WLF_TABS.DATABASE_LIST ? `${styles.headers} ${styles.active}` : `${styles.headers}`
                }
            >
                <Typography
                    variant="Semibold_14"
                    className={
                        selectedTab === WLF_TABS.DATABASE_LIST
