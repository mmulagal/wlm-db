...
import { Button, Popover, TooltipInfo } from '@netapp/design-system';
...
import AssociatedLunsDialogContent from '../../../ResourcePage/DatabaseListTable/AssociatedLunsDialogContent';
...
export function MssqlPgsqlDatabaseTableColDefs({
    ...
    const databaseNameColumn: ColumnProps = {
        id: '1',
    ...
    const instanceNameColumn: ColumnProps = {
    ...
    const hostNameColumn: ColumnProps = {
    ...
    const databaseSizeColumn: ColumnProps = {
    ...
    const associatedLunsColumn: ColumnProps = {
        ...
        id: '13',
        width: '200px',
        filterOptions: lunFilterOptions && lunFilterOptions.length > 0 ? lunFilterOptions : undefined,
    ...
    const protectionStatusColumn: ColumnProps = {
    ...
    const availabilityGroupColumn: ColumnProps = {
                ...
                return (
                    <div className={styles.firstColumnClass}>
                        ...
                        {rowData?.isPrimary && (
                            <div className={styles.firstColText}>
                                <DsTypography variant="Regular_13" className={styles.colText}>
                                    {`${t('databases.general.primary')} | ${rowData.totalReplicaCount || 0} ${
    ...
    const deploymentModelColumn: ColumnProps = {
    ...
    const databaseTypeColumn: ColumnProps = {
    ...
    const fsxForOntapColumn: ColumnProps = {
        id: '7',
    ...
    const awsAccountColumn: ColumnProps = {
    ...
    const regionColumn: ColumnProps = {
    ...
    const isMssql = databaseType === DBType.MSSQL;
    const allColumns: ColumnProps[] = [
        databaseNameColumn,
        instanceNameColumn,
        hostNameColumn,
        databaseSizeColumn,
        ...(isMssql ? [associatedLunsColumn] : []),
        protectionStatusColumn,
        ...(isMssql ? [availabilityGroupColumn, deploymentModelColumn] : []),
        databaseTypeColumn,
        fsxForOntapColumn,
        awsCredentialsColumn,
        awsAccountColumn,
        regionColumn
    ];
