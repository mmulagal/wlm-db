...
const RebaseLineContent = ({ databaseName, sandboxName }: any) => {
    return (
        <div className={styles.rebaseLineContent}>
            <DsTypography variant="Regular_14">
                {GENERAL.REBASELINE_DIALOG_TITLE[0]} <span style={{ fontWeight: '590' }}>{sandboxName}</span>
                {GENERAL.REBASELINE_DIALOG_TITLE[1]}
                <span style={{ fontWeight: '590' }}>{databaseName}</span>?
            </DsTypography>
