...
const MicrosoftSQLPatchTable = ({ lastColDetails, handleBulkAction }: StorageTierTableProps) => {
    ...
    const tableData = useMemo(() => {
        const mssqlPatchAssessmentData: any = [];
...
export default MicrosoftSQLPatchTable;
