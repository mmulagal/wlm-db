...
import TotalMonthlyCostFsxwCalculation from './TotalMonthlyCostFsxwCalculation';
...
const defaultResponse = { fsxwTotalCost: '750' };
...
describe('TotalMonthlyCostFsxwCalculation', () => {
    beforeEach(() => {
        vi.clearAllMocks();
