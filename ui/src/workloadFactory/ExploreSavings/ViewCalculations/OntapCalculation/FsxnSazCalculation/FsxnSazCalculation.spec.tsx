...
import FsxnSazCalculation from './FsxnSazCalculation';
...
const mockViewCalculation = vi.fn().mockReturnValue({
    FSxNCalculation: [
        { label: 'FSxN storage cost', value: '$150' },
...
const defaultResponse = { totalAzCost: '350' };
...
describe('FsxnSazCalculation', () => {
    ...
    it('should render AccordionCard with Single AZ title', () => {
        renderComponent();
        expect(screen.getByTestId('accordion-title').textContent).toBe(GENERAL.ES_FSXN_SINGLE);
    });
