...
import ClonesEBSCalculation from './ClonesEBSCalculation';
...
const createMockStore = (overrides: Record<string, any> = {}) => {
    const defaults = {
        viewCalculationsResponse: { ebsCloneCalculation: { totalCloneMonthlyCost: '100' } },
...
describe('ClonesEBSCalculation', () => {
    ...
    it('should show cost in header when viewCalculationsResponse exists', () => {
        renderComponent({ viewCalculationsResponse: { ebsCloneCalculation: { totalCloneMonthlyCost: '250' } } });
    ...
    it('should call viewCalculationForEBS with correct arguments', () => {
        const response = { ebsCloneCalculation: { totalCloneMonthlyCost: '100' } };
