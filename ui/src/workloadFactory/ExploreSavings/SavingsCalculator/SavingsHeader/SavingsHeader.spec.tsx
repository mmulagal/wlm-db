...
describe('SavingsHeader', () => {
    ...
    it('renders the MSSQL icon', () => {
        const { container } = render(
            <Provider store={makeStore({ savingsCalculatorFrom: SAVINGS_CALC_MODE.AUTO_EBS })}>
                <SavingsHeader />
            </Provider>
        );
    ...
    it('shows EBS header text for MANUAL_EBS', () => {
        const { container } = render(
            <Provider store={makeStore({ savingsCalculatorFrom: SAVINGS_CALC_MODE.MANUAL_EBS })}>
                <SavingsHeader />
            </Provider>
        );
        ...
        const { container } = render(
            <Provider
                store={makeStore({
                    ...
                    selectedExploreSavingsTab: 'other'
                })}
            >
                <SavingsHeader />
            </Provider>
