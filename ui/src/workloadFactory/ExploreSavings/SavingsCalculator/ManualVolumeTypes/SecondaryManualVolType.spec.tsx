...
vi.mock('./ManualTCOInputComponent', () => ({
    default: ({ type, throughPutDisable, IOPSDisable, from }: any) => (
        <div data-testid={`manual-tco-input-${type}`} data-throughput-disable={String(!!throughPutDisable)} data-iops-disable={String(!!IOPSDisable)} data-from={from || 'secondary'}>
...
const filledGp2VolumeTypes2 = {
    ...emptyVolumeTypes2,
    gp2: { manualTCONumberOfVolumes: 10, manualTCOStorageAmount: 200, manualTCOProvisionedIOPS: null, manualTCOThroughput: null }
};
...
describe('SecondaryManualVolType', () => {
    ...
    it('renders Volume Types heading', () => {
        const { container } = render(<Provider store={makeStore()}><SecondaryManualVolType /></Provider>);
    ...
    it('renders total volumes > 0 when gp2 is filled', () => {
        ...
        const { container } = render(<Provider store={store}><SecondaryManualVolType /></Provider>);
    ...
    it('dispatches setSecondaryVolumeFilledStatus(true) when volumes are filled', () => {
        ...
        render(<Provider store={store}><SecondaryManualVolType /></Provider>);
    ...
    it('renders gp2 tab with active class when selectedVolumeTabForSecondary is gp2', () => {
        const { container } = render(<Provider store={makeStore({ selectedVolumeTabForSecondary: 'gp2' })}><SecondaryManualVolType /></Provider>);
    ...
    it('renders gp3 tab with active class when selectedVolumeTabForSecondary is gp3', () => {
        const { container } = render(<Provider store={makeStore({ selectedVolumeTabForSecondary: 'gp3' })}><SecondaryManualVolType /></Provider>);
        const tabs = container.querySelectorAll('.headerPart1');
    ...
    it('renders ManualTCOInputComponent for gp2 tab (no from prop, throughPutDisable and IOPSDisable)', () => {
        render(<Provider store={makeStore({ selectedVolumeTabForSecondary: 'gp2' })}><SecondaryManualVolType /></Provider>);
    ...
    it('renders ManualTCOInputComponent for gp3 tab (no disable flags)', () => {
        render(<Provider store={makeStore({ selectedVolumeTabForSecondary: 'gp3' })}><SecondaryManualVolType /></Provider>);
    ...
    it('renders ManualTCOInputComponent for io1 with throughPutDisable', () => {
        render(<Provider store={makeStore({ selectedVolumeTabForSecondary: 'io1' })}><SecondaryManualVolType /></Provider>);
    ...
    it('renders ManualTCOInputComponent for io2 with throughPutDisable', () => {
        render(<Provider store={makeStore({ selectedVolumeTabForSecondary: 'io2' })}><SecondaryManualVolType /></Provider>);
    ...
    it('renders ManualTCOInputComponent for st1 with throughPutDisable and IOPSDisable', () => {
        render(<Provider store={makeStore({ selectedVolumeTabForSecondary: 'st1' })}><SecondaryManualVolType /></Provider>);
    ...
    it('calculates totalVolumes with multiple filled volume types', () => {
        const multiFilledVolumeTypes2 = {
            ...emptyVolumeTypes2,
            gp2: { manualTCONumberOfVolumes: 10, manualTCOStorageAmount: 200, manualTCOProvisionedIOPS: null, manualTCOThroughput: null },
            io2: { manualTCONumberOfVolumes: 7, manualTCOStorageAmount: 300, manualTCOProvisionedIOPS: 5000, manualTCOThroughput: null }
        };
