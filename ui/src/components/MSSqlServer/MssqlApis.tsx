...
const MssqlApis = () => {
    ...
    } = useGetInstanceTypesQuery({credentialId: selectedCredId, region: selectedRegionCode}, {
        skip: credAndRegionSkip,
    });
    ...
    const { 
        ...
        isError: fsxnError,
    } = useGetFsxnListQuery({credentialId: selectedCredId, region: selectedRegionCode, vpcId: selectedVpcId}, {
        skip: fsxnSkip,
    });
