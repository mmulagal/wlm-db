...
export const GENERAL = {
    ...
    SANDBOX_HEADER_CONTENT:
        'Sandbox is an on-demand, isolated database environment designed to replicate real-world scenarios without affecting production data. It streamlines the development lifecycle by providing an instantaneous copy of your database for testing, integration, diagnostics and training, thereby accelerating time-to-market while ensuring data integrity and security.',
    ...
    SEVEN_FOURTEEN_DAYS: ' 7-14 Days',
    FOURTEEN_THIRTY_DAYS: '14-30 Days',
    THIRTY_PLUS_DAYS: '+30 Days',
    CREATE_SANDBOX: 'Create Sandbox',
    TARGET_HOST: 'Target host',
    TARGET_INSTANCE: 'Target instance',
    TARGET_DATABASES: 'Target database',
    TARGET_DATABASE_NOTICE: 'Notice: Destination host should be in the same VPC and FSxN instance as Source host',
