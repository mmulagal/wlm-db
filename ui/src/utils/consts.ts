...
export const GETWELL_CONFIG: any = {
    ...
    'log-dg-lun-layout': 'log_dg_lun_layout',
...
export const ASSESSMENT_CONFIG_NAMES = {
    ...
    DATA_DG_LUN_LAYOUT: 'DATA ASM Disk Group LUNs layout',
    LOG_DG_LUN_LAYOUT: 'LOGS ASM Disk Group LUNs layout',
    FRA_DG_LUN_LAYOUT: 'FRA ASM diskgroup LUNs layout',
    COMPRESSION: 'Compression',
    DEDUPLICATION: 'Deduplication',
    COMPACTION: 'Compaction',
