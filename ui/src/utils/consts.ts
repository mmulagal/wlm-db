...
export const ASSESSMENT_CONFIG_IDS = {
    ...
    LICENSE: 'sql-license',
    LOG_DG_LUN_LAYOUT: 'redolog-dg-lun-layout',
    LOG_DRIVE_SIZE: 'log-drive-size',
...
export const CONFIG_NAMES = {
    ...
    'redolog-dg-lun-layout': ASSESSMENT_CONFIG_NAMES.LOG_DG_LUN_LAYOUT,
 ...
 */
export const UNDER_PROVISIONED_UNSUPPORTED_FIX_TYPES: Set<string> = new Set([
    ASSESSMENT_CONFIG_IDS.FILE_SYSTEM_HEADROOM,
    ASSESSMENT_CONFIG_IDS.FILE_SYSTEM_HEADROOM_MSSQL,
    ASSESSMENT_CONFIG_IDS.LOG_DRIVE_SIZE,
    ASSESSMENT_CONFIG_IDS.TEMPDB_DRIVE_SIZE
