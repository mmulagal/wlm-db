...
export const getCategoryForAssessment = (assessmentKey: string): string => {
    const categoryMap: { [key: string]: string } = {
        ...
        [ASSESSMENT_CONFIG_NAMES.TRANSPARENT_HUGEPAGES]: 'Compute',
        [ASSESSMENT_CONFIG_NAMES.TCP_ADVANCED_OPTIONS]: 'Compute',
        [ASSESSMENT_CONFIG_NAMES.FILESYSTEMS_IO_OPTIONS]: 'Compute',
        [ASSESSMENT_CONFIG_NAMES.MULTIPATH_READCOUNT]: 'Compute',
        ...
        [ASSESSMENT_CONFIG_NAMES.ORACLE_SECURITY_PATCH]: 'Application',
        [ASSESSMENT_CONFIG_NAMES.CRR]: 'Resiliency',
        [ASSESSMENT_CONFIG_NAMES.SNAPCENTER_SNAPSHOT]: 'Resiliency',
