...
router.get(
    `${BASE_URL}/v1/oracle/credentials/:credentialsId/regions/:region/database-hosts`,
    async (req: {}, res: any) => {
        setTimeout(() => {
            generateResponse(res, 200, OracleDatabaseHosts);
        }, 100);
    }
);
...
router.get(
    `${BASE_URL}/v1/pgsql/credentials/:credentialsId/regions/:region/resource-details`,
    async (req: {}, res: any) => {
        setTimeout(() => {
...
router.get(
    `${BASE_URL}/v1/oracle/credentials/:credentialsId/regions/:region/resource-details`,
    async (req: {}, res: any) => {
        setTimeout(() => {
...
router.post(`${BASE_URL}/v1/mssql/register`, async (req: {}, res: any) => {
    setTimeout(() => {
