...
router.post(
    `${BASE_URL}/v1/:dbType/credentials/:credentialsId/regions/:region/database-hosts/:databaseHostId/database-instances/:databaseInstanceId/logs-analysis`,
...
router.get(
    `${BASE_URL}/v1/mssql/credentials/:credentialsId/regions/:region/database-hosts/:databaseHostId/database-instances/:databaseInstanceId/logs-analysis`,
    async (req: express.Request, res: any) => {
        setTimeout(() => {
...
router.get(
    `${BASE_URL}/v1/oracle/credentials/:credentialsId/regions/:region/database-hosts/:databaseHostId/database-instances/:databaseInstanceId/logs-analysis`,
    async (req: express.Request, res: any) => {
        setTimeout(() => {
...
router.get(
    `${BASE_URL}/v1/:dbType/credentials/:credentialsId/regions/:region/database-hosts/:databaseHostId/database-instances/:databaseInstanceId/logs-analysis/reports`,
    async (req: express.Request, res: any) => {
        setTimeout(() => {
            // generateResponse(res, 500, {message: "Server Error: Unable to fetch logs analysis data."});
...
router.get(
    `${BASE_URL}/v1/mssql/credentials/:credentialsId/regions/:region/logs-analysis/summary`,
    async (req: express.Request, res: any) => {
        setTimeout(() => {
...
router.get(
    `${BASE_URL}/v1/oracle/credentials/:credentialsId/regions/:region/logs-analysis/summary`,
    async (req: express.Request, res: any) => {
        setTimeout(() => {
...
router.get(
    `${BASE_URL}/v1/mssql/credentials/:credentialsId/regions/:region/logs-analysis/pre-requisites`,
    async (req: express.Request, res: any) => {
        setTimeout(() => {
...
router.post(
    `${BASE_URL}/v1/oracle/credentials/:credentialsId/regions/:region/logs-analysis/pre-requisites`,
    async (req: express.Request, res: any) => {
        setTimeout(() => {
