...
describe('onprem-tco-utils', () => {
    ...
    it('invalid sql version', () => {
        expect(parseSqlVersion('{\r\n    \"error\":  \"Error running query \\u0027sqlVersion\\u0027 on instance FCI12\"\r\n}')).toBeUndefined();
    });

    it('should parse valid IOPS array', () => {
        const input = '[{\"writeIops\":\"      0.01\",\"readIops\":\"      0.02\",\"writeBytesPerSec\":\"              138.89\",\"readBytesPerSec\":\"             2030.27\"}]';
    ...
    it('should parse valid storage details array', () => {
        const input = '[{\"databaseName\":\"test\",\"allocatedSizeMb\":16,\"dataSizeMb\":8,\"logSizeMb\":8,\"driveLetter\":\"F:\",\"driveTotalSizeMb\":26605,\"driveAvailableSizeMb\":25549}]';
        expect(parseStorageDetailsByDb(input)).toEqual([{ databaseName: 'test', allocatedSizeMb: 16, dataSizeMb: 8, logSizeMb: 8, driveLetter: 'F:', driveTotalSizeMb: 26605, driveAvailableSizeMb: 25549 }]);
    });

    it('invalid storage details', () => {
        expect(parseStorageDetailsByDb('{\r\n    \"error\":  \"Error running query \\u0027iops\\u0027 on instance FCI12\"\r\n}')).toBeUndefined();
    });
