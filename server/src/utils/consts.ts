...
const CLOUDFORMATION_TO_TERRAFORM_VARIABLE_MAPPING: { [key: string]: { name: string, type: string } } = {
    ...
    'CloudformationEndpointExists': { name: 'cloudformation_endpoint_exists', type: 'boolean' },
    ...
    'JwtToken': { name: 'jwt_token', type: 'string' },
    ...
    'NotificationARN': { name: 'notification_arn', type: 'string' },
    ...
    'SqsEndpointExists': { name: 'sqs_endpoint_exists', type: 'boolean' },
