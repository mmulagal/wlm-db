export const offlineAssessmentDemoFCI = {
    metadata: {
        databaseType: 'MSSQL',
        ...
        ec2InstanceId: 'demo-sql-prod-fci-001',
        ec2InstanceType: {
            Value: 'm5.xlarge'
        },
        vmName: 'SQL-PROD-FCI-01',
    ...
    rawdata: {
        hostLevelDetails: {
            ...
            headroom: {
                aggregateCount: 2,
                storageAvailableInBytes: 1845304655872,
                ssdStorageCapacityInBytes: 1850617864192,
                storageUsedInBytes: 5313208320,
                headroomPercent: 100
            },
            rssConfig: {
                rssAdapters: [],
        ...
        instanceLevelDetails: {
            MSSQLSERVER: {
                    ...
                    volumeDBMap: [
                        {
                            ...
                            databaseName: 'master',
                            ontapVolumeName: 'wlmdb_fci_sqldata_1770775096801'
                        },
                        {
                            ontapVolumeuuid: 'bf0d4032-06f2-11f1-a170-7143fc0c8c33',
                            databaseName: 'master',
                            ontapVolumeName: 'wlmdb_fci_sqllog_1770775096801'
                        },
                        {
                            ontapVolumeuuid: 'b2f08f14-06f2-11f1-a170-7143fc0c8c33',
                            databaseName: 'model',
                        ...
                        },
                        {
                            ...
                            databaseName: 'tempdb',
                            ontapVolumeName: 'wlmdb_fci_sqltemp_1770775096801'
                        },
                        {
                            ontapVolumeuuid: 'b2f08f14-06f2-11f1-a170-7143fc0c8c33',
                    ...
                    luns: [
                        {
                            ...
                            name: '/vol/wlmdb_fci_sqldata_1770775096801/sqldata',
                            serial_number: 'lWB0t?Ze3zn1'
                        },
                        {
                            uuid: '1071ce88-0a92-42d3-bd95-20bed179e67c',
                            name: '/vol/wlmdb_fci_sqltemp_1770775096801/tempdb',
                            serial_number: 'lWB0t?Ze3zn3'
                        },
                        {
                            uuid: '309c04cc-88c3-40f3-b3bc-36e2970f3980',
                            name: '/vol/wlmdb_fci_sqllog_1770775096801/sqllog',
                ...
                instanceDetails: {
                    ...
                    executableInstance: 'SQL-PROD-FCI-01',
                    databaseInstanceId: 'demo-offline-fci-instance-001',
                    windowsClusterNodes: [
                        {
                            Node: 'SQL-PROD-FCI-01',
                            State: 'Up',
                            Address: '10.0.1.10',
                            ec2InstanceId: 'demo-sql-prod-fci-001'
                        },
                        {
                            Node: 'SQL-PROD-FCI-02',
                            State: 'Up',
                            Address: '10.0.1.11',
                            ec2InstanceId: 'demo-sql-prod-fci-002'
                        }
                    ],
                ...
                assessment: {
                            ...
                            tempDb: [
                                {
                                    ...
                                    lunPath: '/vol/wlmdb_fci_sqltemp_1770775096801/tempdb',
                            ...
                            data: [
                                {
                                    ...
                                    lunPath: '/vol/wlmdb_fci_sqldata_1770775096801/sqldata',
                                    svmName: 'wlmdb_sqlsvm_1770775096801',
                                    databaseDetails: [
                                        {
                                            sizeInMb: 204800,
                            ...
                            log: [
                                {
                                    ...
                                    lunPath: '/vol/wlmdb_fci_sqllog_1770775096801/sqllog',
                                    svmName: 'wlmdb_sqlsvm_1770775096801',
                                    databaseDetails: [
                                        {
                                            sizeInMb: 51200,
                            ...
                            details: [
                                {
                                    ...
                                    instanceId: 'demo-sql-prod-fci-001',
                    ...
                    sizing: {
                        'data-tempdb-drive-details': [
                            {
                                ...
                                tempdbDriveTotalSizeMB: 40924,
                                dataDriveLetter: 'S:',
                                dataDriveTotalSizeMB: 767964,
                                ontapVolumeUuid: 'b8fc4031-06f2-11f1-a170-7143fc0c8c33',
                                ontapVolumeName: 'wlmdb_fci_sqltemp_1770775096801',
                                lunUuid: '1071ce88-0a92-42d3-bd95-20bed179e67c',
                                lunPath: '/vol/wlmdb_fci_sqltemp_1770775096801/tempdb',
                        ...
                        'data-log-drive-details': [
                            {
                                databaseName: 'OrderDB',
                                dataDriveLetter: 'S:',
                                dataDriveTotalSizeMB: 204800,
                                logDriveLetter: 'L:',
                                logDrivePath: 'L:\\mssql\\log\\OrderDBLog.ldf',
                                logDriveTotalSizeMB: 51200,
                                ontapVolumeUuid: 'bf0d4032-06f2-11f1-a170-7143fc0c8c33',
                                ontapVolumeName: 'wlmdb_fci_sqllog_1770775096801',
                                lunUuid: '309c04cc-88c3-40f3-b3bc-36e2970f3980',
                            ...
                            },
                            {
                                databaseName: 'PaymentDB',
                                dataDriveLetter: 'S:',
                                dataDriveTotalSizeMB: 153600,
                                logDriveLetter: 'L:',
                                logDrivePath: 'L:\\mssql\\log\\PaymentDBLog.ldf',
                                logDriveTotalSizeMB: 38400,
                                ontapVolumeUuid: 'bf0d4032-06f2-11f1-a170-7143fc0c8c33',
                                ontapVolumeName: 'wlmdb_fci_sqllog_1770775096801',
                                lunUuid: '309c04cc-88c3-40f3-b3bc-36e2970f3980',
                                diskSerialNumber: 'lWB0t?Ze3zn2',
                            ...
                            },
                            {
                                databaseName: 'msdb',
                                dataDriveLetter: 'S:',
                                dataDriveTotalSizeMB: 409564,
                                logDriveLetter: 'L:',
                                logDrivePath: 'L:\\mssql\\log\\MSDBLog.ldf',
                                logDriveTotalSizeMB: 102364,
                                ontapVolumeUuid: 'bf0d4032-06f2-11f1-a170-7143fc0c8c33',
                                ontapVolumeName: 'wlmdb_fci_sqllog_1770775096801',
                                lunUuid: '309c04cc-88c3-40f3-b3bc-36e2970f3980',
                                diskSerialNumber: 'lWB0t?Ze3zn2',
                        ...
                        'performance-tier': [
                            {
                                volumeName: 'wlmdb_fci_sqldata_1770775096801',
                                performanceTierPercent: 100
                            },
                            {
                                volumeName: 'wlmdb_fci_sqllog_1770775096801',
                                performanceTierPercent: 100
                            },
                            {
                                volumeName: 'wlmdb_fci_sqltemp_1770775096801',
                                performanceTierPercent: 100
                            }
                        ]
                    }
