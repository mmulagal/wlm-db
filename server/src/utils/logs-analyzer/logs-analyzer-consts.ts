...
const LOGS_ANALYZER_INFERENCE_PROFILE = `arn:aws:bedrock:us-east-1:464262061435:inference-profile/us.${LOGS_ANALYZER_MODEL_ID}`;
...
export {
    ...
    LOGS_ANALYZER_INFERENCE_PROFILE
};
