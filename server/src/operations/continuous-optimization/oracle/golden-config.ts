...
const GOLDEN_CONFIG = {
        ...
        volume: [
            {
                ...
                summary: 'Enable thin provisioning for optimal storage efficiency',
                recommendation:
            ...
            },
            {
                ...
                summary: 'Enable volume autogrow to prevent storage capacity issues',
                recommendation:
            ...
            },
            {
                ...
                focusWidgetName: 'ONTAP',
                severity: SEVERITY.CRITICAL,
                summary: 'Set autosize mode to grow for dynamic volume expansion',
                recommendation:
            ...
            },
            {
                ...
                focusWidgetName: 'ONTAP',
                severity: SEVERITY.CRITICAL,
                summary: 'Disable fractional reserve to maximize usable capacity',
                recommendation:
            ...
            },
            {
                ...
                focusWidgetName: 'ONTAP',
                severity: SEVERITY.WARNING,
                summary: 'Disable snapshots; use SnapCenter for application consistency',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.WARNING,
                // prettier-ignore
                summary: 'Don\'t reserve capacity for snapshots; maximize active data',
                recommendation:
            ...
            },
            {
                ...
                focusWidgetName: 'ONTAP',
                severity: SEVERITY.WARNING,
                summary: 'Enable automatic deletion of old snapshots automatically',
                recommendation:
            ...
            },
            {
                ...
                focusWidgetName: 'ONTAP',
                severity: SEVERITY.WARNING,
                summary: 'Configure space management to grow volumes before deleting',
                recommendation:
            ...
            },
            {
                ...
                focusWidgetName: 'ONTAP',
                severity: SEVERITY.CRITICAL,
                summary: 'Enable snapshot-only tiering for cost reduction',
                recommendation:
            ...
            },
            {
                ...
                focusWidgetName: 'ONTAP',
                severity: SEVERITY.CRITICAL,
                summary: 'Set cooling days for optimal data tiering effectiveness',
                recommendation:
            ...
            },
            {
                ...
                focusWidgetName: 'ONTAP',
                severity: SEVERITY.CRITICAL,
                summary: 'Enable inline adaptive compression for storage efficiency',
                recommendation:
            ...
            },
            {
                ...
                focusWidgetName: 'ONTAP',
                severity: SEVERITY.CRITICAL,
                summary: 'Enable deduplication for data volumes to optimize storage',
                recommendation:
                    'Workload Factory recommends implementing storage efficiencies—compression, compaction, and deduplication—in NetApp ONTAP for Oracle database environments to significantly reduce storage footprint, lower costs, and optimize resource utilization while maintaining performance. Tailored settings for each volume type ensure alignment with Oracle’s I/O patterns: Data and archive Volumes benefit from inline adaptive compression (8KB), compaction and deduplication while Redo Log Volumes prioritize performance with minimal savings from these features.',
                tags: [
                    AwsWellArchitecturedPillars.COST_OPTIMIZATION,
            ...
            },
            {
                ...
                focusWidgetName: 'ONTAP',
                severity: SEVERITY.CRITICAL,
                summary: 'Enable compaction for improved storage space efficiency',
                recommendation:
                    'Workload Factory recommends implementing storage efficiencies—compression, compaction, and deduplication—in NetApp ONTAP for Oracle database environments to significantly reduce storage footprint, lower costs, and optimize resource utilization while maintaining performance. Tailored settings for each volume type ensure alignment with Oracle’s I/O patterns: Data and archive Volumes benefit from inline adaptive compression (8KB), compaction and deduplication while Redo Log Volumes prioritize performance with minimal savings from these features.',
                tags: [
                    AwsWellArchitecturedPillars.COST_OPTIMIZATION,
        ...
        volume_nfs: [
            {
                ...
                severity: SEVERITY.CRITICAL,
                resourceType: 'Volume',
                summary: 'Disable NFS root-only restriction for dNFS compatibility',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.CRITICAL,
                resourceType: 'Volume',
                summary: 'Enable superuser and setuid for Oracle binary execution',
                recommendation:
        ...
        os_iscsi: [
            {
                ...
                summary: 'Enable Multipath I/O for iSCSI storage resilience',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.WARNING,
                resourceType: 'EC2 Instance',
                summary: 'Install host utilities for LUN and multipath management',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.WARNING,
                resourceType: 'EC2 Instance',
                summary: 'Configure 4 iSCSI sessions for multipath connectivity',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.WARNING,
                resourceType: 'EC2 Instance',
                summary: 'Disable Transparent HugePages for Oracle database stability',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.CRITICAL,
                resourceType: 'EC2 Instance',
                summary: 'Set iSCSI timeout to 5 seconds for fast failover',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.WARNING,
                resourceType: 'EC2 Instance',
                summary: 'Enable multipath friendly names for management simplicity',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.WARNING,
                resourceType: 'EC2 Instance',
                summary: 'Enable TCP options: timestamps, SACK, window scaling',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.WARNING,
                resourceType: 'EC2 Instance',
                summary: 'Set filesystemio_options to setall for optimal I/O',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.WARNING,
                resourceType: 'EC2 Instance',
                summary: 'Remove db_file_multiblock_read_count for automatic management',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.CRITICAL,
                resourceType: 'EC2 Instance',
                summary: 'Configure /etc/multipath.conf with NetApp ONTAP settings',
                recommendation:
        ...
        asmOS: [
            {
                ...
                severity: SEVERITY.WARNING,
                resourceType: 'EC2 Instance',
                summary: 'Use Oracle ASM for iSCSI-based storage management',
                recommendation:
            ...
            },
            {
                ...
                summary: 'Set ASM redundancy to external with multipath protection',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.CRITICAL,
                resourceType: 'EC2 Instance',
                summary: 'Configure AFD logical block size for ONTAP alignment',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.CRITICAL,
                resourceType: 'EC2 Instance',
                summary: 'Configure ASMLib logical block size for storage alignment',
                recommendation:
        ...
        os_nfs: [
            {
                ...
                severity: SEVERITY.CRITICAL,
                resourceType: 'EC2 Instance',
                summary: 'Configure TCP slot table to 128 for Oracle workloads',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.WARNING,
                resourceType: 'EC2 Instance',
                summary: 'Use optimized NFS mount options for database files',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.WARNING,
                resourceType: 'EC2 Instance',
                summary: 'Use optimized NFS mount options for ADR home location',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.CRITICAL,
                resourceType: 'EC2 Instance',
                summary: 'Match NFSv4 domain names between host and NFS server',
                recommendation:
            ...
            },
            {
                ...
                severity: SEVERITY.WARNING,
                resourceType: 'EC2 Instance',
                summary: 'Avoid cache-disabling mount options for performance',
                recommendation:
    ...
    archivePlacement: {
        ...
        severity: SEVERITY.WARNING,
        summary: 'Place archive logs on dedicated volume for performance',
        recommendation:
    ...
    datafilesPlacement: {
        ...
        severity: SEVERITY.WARNING,
        summary: 'Isolate data files from logs to reduce I/O contention',
        recommendation:
    ...
    controlfilesPlacement: {
        ...
        severity: SEVERITY.WARNING,
        summary: 'Multiplex control files across volumes for redundancy',
        recommendation:
    ...
    redologsPlacement: {
        ...
        severity: SEVERITY.WARNING,
        summary: 'Place redo logs separately to isolate high-write I/O',
        recommendation:
    ...
    templogsPlacement: {
        ...
        category: 'storage',
        subCategory: 'layout',
        focusWidgetName: 'Temp logs placement',
        severity: SEVERITY.WARNING,
        summary: 'Place temporary logs separately to isolate bulk I/O',
        recommendation:
    ...
    oracleBinaryPlacement: {
        ...
        category: 'storage',
        subCategory: 'layout',
        focusWidgetName: 'Oracle binaries placement',
        severity: SEVERITY.WARNING,
        summary: 'Place Oracle binaries on dedicated volume for stability',
        recommendation:
    ...
    dataDiskLunLayout: {
        ...
        severity: SEVERITY.WARNING,
        summary: 'Configure 4-8 LUNs in ASM data disk group for performance',
        recommendation:
    ...
    redoLogDiskLunLayout: {
        ...
        severity: SEVERITY.WARNING,
        summary: 'Configure 2-8 LUNs in ASM redo log disk group',
        recommendation:
    ...
    fraDiskLunLayout: {
        ...
        severity: SEVERITY.WARNING,
        summary: 'Configure 2-8 LUNs in ASM archive log disk group',
        recommendation:
    ...
    sizing: [
        {
            ...
            severity: SEVERITY.CRITICAL,
            summary: 'Size swap space relative to RAM for memory pressure handling',
        ...
        },
        {
            ...
            severity: SEVERITY.CRITICAL,
            summary: 'Maintain 20% file system headroom for optimal performance',
