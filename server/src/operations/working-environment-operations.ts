...
import { RESOURCESTYPE, HttpErrorCodes, ACCOUNT_ID, DEFAULT_INSTANCE_NAME } from '../utils/consts';
...
async function getMSSQLEnvData(resourceDetails: any, resourceId: string) {
    ...
    if (activeNodeInstanceId) {
        ...
        const dbCount = await getDatabasesCount(credentialsId, region, activeNodeInstanceId!, [DEFAULT_INSTANCE_NAME]);
