...
export async function getDsClient(region: string, credentialsId: string) {
...
export async function describeDirectories(credentialsId: string, region: string, params: object) {
