...
import { PricingServiceRequestType, PricingServiceResponseType } from './types/pricing.types';
...
export default function prisingRoutes(fastify: FastifyInstance) {
    ...
    server.post<{
        Body: PricingServiceRequestType;
        Reply: PricingServiceResponseType;
    }>(API_PATH_PRICING, { schema: CalculatePriceSchema }, async (request, reply) => {
