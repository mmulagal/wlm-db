...
const PricingServiceRequestV2 = Type.Object({
    compute: Type.Object({
        regionCode: Type.String({ minLength: 1 }),
        instanceType: Type.String({ minLength: 1 }),
        sqlSoftwareType: Type.String({ enum: [SQL_STD, SQL_ENT, SQL_WEB, CUSTOM] }),
...
const PricingServiceResponseV2 = Type.Object({
    compute: Type.Number(),
    fsxnStorage: Type.Optional(
        Type.Object({
...
type PricingServiceRequestTypeV2 = Static<typeof PricingServiceRequestV2>;
type PricingServiceResponseType = Static<typeof PricingServiceResponse>;
type PricingServiceResponseTypeV2 = Static<typeof PricingServiceResponseV2>;
