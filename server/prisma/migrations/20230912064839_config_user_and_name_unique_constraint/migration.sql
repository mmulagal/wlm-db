/*
  ...
  - A unique constraint covering the columns `[account_id,name,user]` on the table `config` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `uk_wlmdb_config_account_id_name_user` ON `config`(`account_id`, `name`, `user`);
