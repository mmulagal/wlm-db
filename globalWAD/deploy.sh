...
aws s3 cp build/wad-config.json s3://$bucket/wlmdb/wad-config.json --content-type "application/json" --cache-control='public,max-age=300,stale-while-revalidate=60'
